...
{
    public partial class ReporteHallazgos : System.Web.UI.UserControl
    {
        ...
        private void loadGridReporteRiesgos()
        {
            ...
            grid.Columns.Add("Tipo de Hallazgo", typeof(string));
            grid.Columns.Add("Estado del Hallazgo", typeof(string));
            grid.Columns.Add("Descripción del Hallazgo", typeof(string));
        ...
        private void loadInfoReporteRiesgos()
        {
            ...
            dtInfo = cAu.LoadReporteHallazgos(IdPlaneaciones, IdAuditorias, IdProcesos, IdHijos, IdUsuarios);
            if (dtInfo.Rows.Count > 0)
            {
                for (int rows = 0; rows < dtInfo.Rows.Count; rows++)
                {
                    ...
                    InfoGrid.Rows.Add(new Object[] {dtInfo.Rows[rows]["Planeación"].ToString().Trim(),
                                                                  ...
                                                                  dtInfo.Rows[rows]["Tipo de Hallazgo"].ToString().Trim(),
                                                                  dtInfo.Rows[rows]["Estado del Hallazgo"].ToString().Trim(),
                                                                  dtInfo.Rows[rows]["Descripción del Hallazgo"].ToString().Trim(),
