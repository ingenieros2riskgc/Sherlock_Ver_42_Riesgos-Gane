<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IndicadoresResultados.ascx.cs" Inherits="ListasSarlaft.UserControls.MAuditoria.Indicadores.IndicadoresResultados" %>
    ...
    <ContentTemplate>
        ...
        <table width="100%">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label6" runat="server" ForeColor="White" Text="Indicadores de Auditoria"
            ...
            <tr>
                <td>
                    <table align="center" width="100%">
                        <tr align="center" bgcolor="#EEEEEE" id="filaTipoIndicador" runat="server">
                            <td>
                                <table class="tabla">
                                    <tr align="left">
                                        <td bgcolor="#BBBBBB">
                                            <asp:Label ID="lblTipoIndicador" runat="server" CssClass="Apariencia" Text="Tipo de Indicador:"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="ddlTipoInd" runat="server">
                                                <asp:ListItem Value="0" Text="--Seleccione--"></asp:ListItem>
                                                <asp:ListItem Value="1" Text="Auditorias"></asp:ListItem>
                                                <asp:ListItem Value="2" Text="Recomendaciones"></asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                                        ...
                                                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                            ...
                                                            <Columns>
                                                                <asp:BoundField DataField="Metodologia" HeaderText="Metodologia"
                                                                    ReadOnly="True" SortExpression="Metodologia">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="Frecuencia" HeaderText="Frecuencia"
                                                                    SortExpression="Frecuencia" ReadOnly="True" HtmlEncode="False"
                                                                ...
                                                                <asp:BoundField DataField="Meta" HeaderText="Meta"
                                                                    SortExpression="Meta" ReadOnly="True" HtmlEncode="False"
                                                                    HtmlEncodeFormatString="False">
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="ENE" HeaderText="ENE"
                                                                    SortExpression="ENE" ReadOnly="True" HtmlEncode="False"
                                                                    HtmlEncodeFormatString="False">
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                </asp:BoundField>
