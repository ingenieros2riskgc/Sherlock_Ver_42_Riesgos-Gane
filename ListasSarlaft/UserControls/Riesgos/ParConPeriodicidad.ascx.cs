...
namespace ListasSarlaft.UserControls.Riesgos
{
    public partial class ParConPeriodicidad : System.Web.UI.UserControl
    {
        ...
        private void loadGrid()
        {
            ...
            grid.Columns.Add("Valor", typeof(decimal));
            InfoGrid = grid;
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    PeriodicidadDTO.dcValor = Convert.ToDecimal(Sanitizer.GetSafeHtmlFragment(txtValor.Text.Trim()));
        ...
        private void detalleRegistro()
        {
            ...
            txtValor.Text = InfoGrid.Rows[RowGrid]["Valor"].ToString().Trim();
            Session["Valor"] = InfoGrid.Rows[RowGrid]["Valor"].ToString().Trim();
