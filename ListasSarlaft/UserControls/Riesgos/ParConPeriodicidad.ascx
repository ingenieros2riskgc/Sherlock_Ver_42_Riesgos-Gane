<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParConPeriodicidad.ascx.cs"
    Inherits="ListasSarlaft.UserControls.Riesgos.ParConPeriodicidad" %>
            ...
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                        ForeColor="White" Text="Periodicidad"></asp:Label>
                </td>
            </tr>
            <tr align="center">
                <td>
            ...
            <tr align="center" id="trCampos" runat="server" visible="false">
                <td>
                    <table>
                        <tr align="center">
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Periodicidad" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                            </td>
                            <td bgcolor="#EEEEEE">
                        ...
                        <tr align="center">
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="lblValorPe" runat="server" Text="Valor Periodicidad" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                            </td>
                            <td bgcolor="#EEEEEE">
                                <asp:TextBox ID="txtValor" runat="server" Width="450px" Font-Names="Calibri" Font-Size="Small" MaxLength="3"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvVakir" runat="server" ControlToValidate="txtValor"
                                    InitialValue="" ForeColor="Red" ValidationGroup="validarCampos">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr align="center">
