<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Salida.ascx.cs" Inherits="ListasSarlaft.UserControls.Proceso.Salida" %>
    ...
    <ContentTemplate>
        ...
        <table align="center" width="80%">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Salidas" Font-Bold="False"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#EEEEEE">
                    <table class="tabla" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvDescripcion" runat="server" ControlToValidate="tbxDescripcion"
                                    ...
                                    ValidationGroup="iSalida" ForeColor="Red">*</asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator runat="server" ID="rfvDescLen" Display="Dynamic" ForeColor="Red"
                                    ControlToValidate="tbxDescripcion" ValidationExpression="^[\s\S]{0,250}$" ValidationGroup="iSalida"
                        ...
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="Cliente:" CssClass="Apariencia"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="tbxCliente" runat="server" Width="100px" CssClass="Apariencia" MaxLength="250"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvCliente" runat="server" ControlToValidate="tbxCliente"
                                    ErrorMessage="Debe ingresar el Cliente." ToolTip="Debe ingresar el Cliente."
                                    ValidationGroup="iSalida" ForeColor="Red">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iSalida" />
                                        ...
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                ...
                                                ToolTip="Guardar" ValidationGroup="iSalida" />
                                        </td>
                                        <td>
