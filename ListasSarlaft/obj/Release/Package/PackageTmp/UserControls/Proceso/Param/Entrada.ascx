<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Entrada.ascx.cs" Inherits="ListasSarlaft.UserControls.Proceso.Entrada" %>
    ...
    <ContentTemplate>
        ...
        <table align="center" width="80%">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Entradas" Font-Bold="False"
                ...
                <td bgcolor="#EEEEEE">
                    <table class="tabla" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="tbxDescripcion" runat="server" CssClass="Apariencia" MaxLength="250" Height="42px"
                                    Width="800px" Columns="100" Rows="8" TextMode="MultiLine" Font-Size="10pt" Font-Bold="False"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvDescripcion" runat="server" ControlToValidate="tbxDescripcion"
                                    ...
                                    ValidationGroup="iEntrada" ForeColor="Red">*</asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator runat="server" ID="rfvDescLen" Display="Dynamic" ForeColor="Red"
                                    ControlToValidate="tbxDescripcion" ValidationExpression="^[\s\S]{0,250}$" ValidationGroup="iEntrada"
                        ...
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="Proveedor:" CssClass="Apariencia"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="tbxProveedor" runat="server" Width="100px" CssClass="Apariencia" MaxLength="250"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvProveedor" runat="server" ControlToValidate="tbxProveedor"
                                    ErrorMessage="Debe ingresar el proveedor." ToolTip="Debe ingresar el proveedor."
                                    ValidationGroup="iEntrada" ForeColor="Red">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iEntrada" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                ...
                                                ToolTip="Guardar" ValidationGroup="iEntrada" />
                                        </td>
                                        <td>
