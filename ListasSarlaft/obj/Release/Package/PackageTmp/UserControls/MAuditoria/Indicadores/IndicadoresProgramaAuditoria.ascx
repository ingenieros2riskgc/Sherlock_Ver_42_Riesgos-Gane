<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IndicadoresProgramaAuditoria.ascx.cs" Inherits="ListasSarlaft.UserControls.MAuditoria.Indicadores.IndicadoresProgramaAuditoria" %>
    ...
    <ContentTemplate>
        ...
        <table width="100%">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label6" runat="server" ForeColor="White" Text="Indicador Programa Auditoria"
                                        ...
                                        <td>
                                            <br />
                                                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                            ...
                                                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                            <Columns>
                                                                <asp:BoundField DataField="Código Riesgo" HeaderText="Código Riesgo"
                                                                    ReadOnly="True" SortExpression="Código Riesgo">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="Tipo de Proceso" HeaderText="Tipo de Proceso"
                                                                    SortExpression="Tipo de Proceso" ReadOnly="True" HtmlEncode="False"
                                                                ...
                                                                <asp:BoundField DataField="Subproceso" HeaderText="Subproceso"
                                                                    SortExpression="Subproceso" ReadOnly="True" HtmlEncode="False"
                                                                    HtmlEncodeFormatString="False">
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="Riesgo de proceso" HeaderText="Riesgo de proceso"
                                                                    SortExpression="Riesgo de proceso" ReadOnly="True" HtmlEncode="False"
                                                                    HtmlEncodeFormatString="False">
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="Causas" HeaderText="Causas" SortExpression="Causas"
                                                                    ReadOnly="True">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="Objetivo estratégico asociado" HeaderText="Objetivo estratégico asociado"
                                                                    SortExpression="Objetivo estratégico asociado">
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="Sistema SAR" HeaderText="Sistema SAR"
                                                                    SortExpression="Sistema SAR" ReadOnly="True">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="Código Control" HeaderText="Código Control"
                                                                    SortExpression="Código Control" ReadOnly="True">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="Descripción de la actividad de control" HeaderText="Descripción de la actividad de control"
                                                                    SortExpression="Descripción de la actividad de control" ReadOnly="True">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="Objetivo del control" HeaderText="Objetivo del control"
                                                                    SortExpression="Objetivo del control" ReadOnly="True">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="Procedimiento Asociado" HeaderText="Procedimiento Asociado"
                                                                    SortExpression="Procedimiento Asociado" ReadOnly="True">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="Responsable del control" HeaderText="Responsable del control"
                                                                    SortExpression="Responsable del control" ReadOnly="True">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="(P)ermanente,(E)special,(X)Excepción" HeaderText="(P)ermanente,(E)special,(X)Excepción"
                                                                    SortExpression="(P)ermanente,(E)special,(X)Excepción" ReadOnly="True">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="AUDITOR (S)" HeaderText="AUDITOR (S)"
                                                                    SortExpression="AUDITOR (S)" ReadOnly="True">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="PERIOCIDAD" HeaderText="PERIOCIDAD"
                                                                    SortExpression="PERIOCIDAD" ReadOnly="True">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="AUDITADO" HeaderText="AUDITADO"
                                                                    SortExpression="AUDITADO" ReadOnly="True">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="REALIZADAS" HeaderText="REALIZADAS"
                                                                    SortExpression="REALIZADAS" ReadOnly="True">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="PROGRAMADAS" HeaderText="PROGRAMADAS"
                                                                    SortExpression="PROGRAMADAS" ReadOnly="True">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="CUMPLIMIENTO" HeaderText="CUMPLIMIENTO"
                                                                    SortExpression="CUMPLIMIENTO" ReadOnly="True">
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
